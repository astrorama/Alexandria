...
//  typedef Euclid::ChMath::Function data_type;
  ...
  public:
    ...
    data_type& operator*() {
      ...
      if (new_sed_index != m_current_sed_index || new_reddening_curve_index != m_current_reddening_curve_index
        ...
        double ebv = std::get<Euclid::PhzDataModel::ModelParameter::EBV>(m_owner.m_axes_tuple)[new_ebv_index];
      ...
      if (new_sed_index != m_current_sed_index || new_reddening_curve_index != m_current_reddening_curve_index
        ...
        double z = std::get<Euclid::PhzDataModel::ModelParameter::Z>(m_owner.m_axes_tuple)[new_z_index];
  ...
  ModelCellManager(Euclid::PhzDataModel::ModelAxesTuple axes_tuple,
