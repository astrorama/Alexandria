...
namespace MathUtils {
  ...
  Cumulative::Cumulative ( Cumulative && other):m_x_sampling(std::move(other.m_x_sampling)), m_y_sampling(std::move(other.m_y_sampling)){}
  ...
  Cumulative::Cumulative(std::vector<double>& x_sampling, std::vector<double>& y_sampling): m_x_sampling(x_sampling), m_y_sampling(y_sampling){
