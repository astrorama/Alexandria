...
BOOST_FIXTURE_TEST_CASE(ConstructorEmptyComment, AsciiReader_Fixture) {
  ...
  // Then
  BOOST_CHECK_THROW(ChTable::AsciiReader({} ,{} ,comment), ElementsException);
...
BOOST_FIXTURE_TEST_CASE(ConstructorDuplicateColumnNames, AsciiReader_Fixture) {
  ...
  // Then
  BOOST_CHECK_THROW(ChTable::AsciiReader({} , names), ElementsException);
...
BOOST_FIXTURE_TEST_CASE(ConstructorColumnNamesWithWhitespaces, AsciiReader_Fixture) {
  ...
  // Then
  BOOST_CHECK_THROW(ChTable::AsciiReader({}, space), ElementsException);
  BOOST_CHECK_THROW(ChTable::AsciiReader({}, tab), ElementsException);
  BOOST_CHECK_THROW(ChTable::AsciiReader({}, carriage_return), ElementsException);
  BOOST_CHECK_THROW(ChTable::AsciiReader({}, new_line), ElementsException);
  BOOST_CHECK_THROW(ChTable::AsciiReader({}, new_page), ElementsException);
...
BOOST_FIXTURE_TEST_CASE(ConstructorColumnNameTypeDifferentSize, AsciiReader_Fixture) {
  ...
  // Then
  BOOST_CHECK_THROW(ChTable::AsciiReader(types, names), ElementsException);
...
BOOST_FIXTURE_TEST_CASE(ReadSuccess, AsciiReader_Fixture) {
  ...
  // Given
  ChTable::AsciiReader reader {};
  std::stringstream in {all_types};
  
  // When
  ChTable::Table table = reader.read(in);
...
BOOST_FIXTURE_TEST_CASE(ReadOverrideTypes, AsciiReader_Fixture) {
  ...
  // Given
  ChTable::AsciiReader reader {{typeid(bool), typeid(std::string), typeid(int32_t), typeid(int32_t), typeid(int32_t)}};
...
BOOST_FIXTURE_TEST_CASE(ReadOverrideNames, AsciiReader_Fixture) {
  ...
  // Given
  ChTable::AsciiReader reader {{}, {"A","B","C","D","E"}};
  std::stringstream in {multiple_comments};
...
BOOST_FIXTURE_TEST_CASE(ReadNoData, AsciiReader_Fixture) {
  ...
  // Given
  ChTable::AsciiReader hashReader {{},{},"#"};
  ChTable::AsciiReader doubleSlashReader {{},{},"//"};
