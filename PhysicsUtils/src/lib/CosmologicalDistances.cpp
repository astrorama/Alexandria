...
namespace PhysicsUtils {
 ...
 double CosmologicalDistances::comovingDistance(double z,
   ...
   FunctionWrapper wrapper([&parameters,this](double x) {return 1./hubbleParameter(x,parameters);});

   return hubbleDistance(parameters)*integrate(wrapper,0.,z,std::move(integrationScheme));
