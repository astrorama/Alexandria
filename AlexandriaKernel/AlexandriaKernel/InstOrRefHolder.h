...
/**
 * Interface for classes that can store either an instance or a reference to an object.
 * Objects that provide this interface are to be created with InstOrRefHolder<InterfaceType>::create
