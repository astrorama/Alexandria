 ...
 * 
 * @tparam GridCellManager the type of the data manager of the GridContainer
...
void binaryExport(std::ostream& out, const GridContainer<GridCellManager, AxesTypes...>& matrix) {
  // Do NOT delete this pointer!!! It  points to the actual matrix
  const GridContainer<GridCellManager, AxesTypes...>* ptr = &matrix;
 ...
 */
template<typename GridCellManager, typename... AxesTypes>
GridContainer<GridCellManager, AxesTypes...> binaryImport(std::istream& in) {
