...
struct GridConstructionHelper_Fixture {
  ...
  typedef Euclid::Grid::GridConstructionHelper<int, int, int, int> Helper;
};
...
BOOST_FIXTURE_TEST_CASE(createAxesSizesVector, GridConstructionHelper_Fixture) {
  ...
  // When
  std::vector<size_t> result = Helper::createAxesSizesVector(axes_tuple, Euclid::Grid::TemplateLoopCounter<4>{});
...
BOOST_FIXTURE_TEST_CASE(createAxisIndexFactorVector, GridConstructionHelper_Fixture) {
  ...
  // When
  std::vector<size_t> result = Helper::createAxisIndexFactorVector(axes_tuple, Euclid::Grid::TemplateLoopCounter<4>{});
