...
BOOST_FIXTURE_TEST_CASE(ConstructorEmptyComment, AsciiWriter_Fixture) {
  ...
  // Then
  BOOST_CHECK_THROW(Euclid::Table::AsciiWriterOld {comment}, Elements::Exception);
...
BOOST_FIXTURE_TEST_CASE(write, AsciiWriter_Fixture) {
  ...
  Euclid::Table::AsciiWriterOld writer_hash {};
  Euclid::Table::AsciiWriterOld writer_double_slash {"//"};
