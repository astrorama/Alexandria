...
struct AsciiWriter_Fixture {
  ...
  std::vector<Row::cell_type>        values1{false,
                                      ...
                                      42e-16,
                                      0.f,
                                      std::vector<double>{2.1, 2.2},
                                      NdArray<double>{{2, 2}, {9, 8, 7, 6}}};
  Row                                row1{values1, column_info};
  std::vector<Row::cell_type>        values2{true,
                                      std::string{"Two 3"},
                                      234,
                                      4.3,
                                      0.f,
                                      std::vector<double>{3.1, 3.2, 3.3, 3.4},
                                      NdArray<double>{{2, 2}, {1, 3, 5, 7}}};
