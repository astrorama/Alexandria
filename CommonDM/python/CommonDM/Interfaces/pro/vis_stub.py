# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/CommonDM/Interfaces/pro/vis_stub.py
# PyXB bindings for NamespaceModule
# NSM:539c73c8f73a663b381cbefc2c790f5c063cac08
# Generated 2014-03-14 15:21:54.445465 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
import CommonDM.pro.vis_stub
import CommonDM.pro.sim_stub
...
VisInputConfiguration = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'VisInputConfiguration'), CommonDM.pro.vis_stub.visBaseFrame)
Namespace.addCategoryObject('elementBinding', VisInputConfiguration.name().localName(), VisInputConfiguration)

GainLinearityInputConfiguration = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'GainLinearityInputConfiguration'), CommonDM.pro.vis_stub.gainLinearity)
...
SimInputConfiguration = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'SimInputConfiguration'), CommonDM.pro.sim_stub.visInputConfiguration)
...
BiasInput._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Master'), CommonDM.pro.vis_stub.masterFlatFrame, scope=BiasInput))

BiasInput._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Bias'), CommonDM.pro.vis_stub.biasFrame, scope=BiasInput))
