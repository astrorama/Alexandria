# /home/nikoapos/ISDC/Projects/Alexandria/2.0/CommonDM/python/CommonDM/dm/pro/le3_stub.py
# PyXB bindings for NamespaceModule
# NSM:6e92490d80fbb6dc02a66078ea11ba566a411393
# Generated 2014-06-12 14:36:51.817258 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
STD_ANON_.Lin = STD_ANON_._CF_enumeration.addEnumeration(unicode_value=u'Lin')
STD_ANON_.Log = STD_ANON_._CF_enumeration.addEnumeration(unicode_value=u'Log')
...
STD_ANON_2.Cartesian = STD_ANON_2._CF_enumeration.addEnumeration(unicode_value=u'Cartesian')
STD_ANON_2.Spherical = STD_ANON_2._CF_enumeration.addEnumeration(unicode_value=u'Spherical')
...
STD_ANON_3.None_ = STD_ANON_3._CF_enumeration.addEnumeration(unicode_value=u'None')
STD_ANON_3.BootStrap = STD_ANON_3._CF_enumeration.addEnumeration(unicode_value=u'BootStrap')
STD_ANON_3.Jackknife = STD_ANON_3._CF_enumeration.addEnumeration(unicode_value=u'Jackknife')
...
STD_ANON_4.arcsec = STD_ANON_4._CF_enumeration.addEnumeration(unicode_value=u'arcsec')
STD_ANON_4.arcmin = STD_ANON_4._CF_enumeration.addEnumeration(unicode_value=u'arcmin')
...
class CTD_ANON (pyxb.binding.basis.complexTypeDefinition):
    ...
    __NRCat2 = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'NRCat2'), 'NRCat2', '__httpeuclid_esa_orgschemaprole3_CTD_ANON_NRCat2', False)

    
    NRCat2 = property(__NRCat2.value, __NRCat2.set, None, None)

    
    # Element NRCat1 uses Python identifier NRCat1
    __NRCat1 = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'NRCat1'), 'NRCat1', '__httpeuclid_esa_orgschemaprole3_CTD_ANON_NRCat1', False)

    
    NRCat1 = property(__NRCat1.value, __NRCat1.set, None, None)
...
class athenaParams (pyxb.binding.basis.complexTypeDefinition):
    ...
    ScoordOutput = property(__ScoordOutput.value, __ScoordOutput.set, None, u' Coordinate units of output files.')
    ...
    ScoordInput = property(__ScoordInput.value, __ScoordInput.set, None, u' Coordinate units of input catalogues.')
    ...
    BinType = property(__BinType.value, __BinType.set, None, u' "Lin" or "Log" for linear or logarithmic bins. ')
    ...
    Coordinates = property(__Coordinates.value, __Coordinates.set, None, u' Choose "Cartesian" or "Spherical" system of coordinates. ')
    ...
    # Element NResample uses Python identifier NResample
    __NResample = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'NResample'), 'NResample', '__httpeuclid_esa_orgschemaprole3_athenaParams_NResample', False)

    
    NResample = property(__NResample.value, __NResample.set, None, u' Give number of samples for error calculations for catalog 1 and 2. ')
    ...
    EstError = property(__EstError.value, __EstError.set, None, u' Controls error type, either "None","Bootstrap" or "Jackknife". ')
...
class athenaParamsPosPos2D (athenaParams):
    ...
    # Element NResample (NResample) inherited from {http://euclid.esa.org/schema/pro/le3}athenaParams
...
class pallasParams (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element max_ell uses Python identifier max_ell
    __max_ell = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'max_ell'), 'max_ell', '__httpeuclid_esa_orgschemaprole3_pallasParams_max_ell', False)

    
    max_ell = property(__max_ell.value, __max_ell.set, None, u' Maximal band limit. ')

    
    # Element min_ell uses Python identifier min_ell
    __min_ell = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'min_ell'), 'min_ell', '__httpeuclid_esa_orgschemaprole3_pallasParams_min_ell', False)

    
    min_ell = property(__min_ell.value, __min_ell.set, None, u' Minimal band limit. ')
    ...
    _ElementMap = {
        __max_ell.name() : __max_ell,
        __min_ell.name() : __min_ell,
        __nbins.name() : __nbins
    }
    _AttributeMap = {
...
class pallasParamsShearShear2d (pallasParams):
    ...
    # Element max_ell (max_ell) inherited from {http://euclid.esa.org/schema/pro/le3}pallasParams
    
    # Element nbins (nbins) inherited from {http://euclid.esa.org/schema/pro/le3}pallasParams
    
    # Element min_ell (min_ell) inherited from {http://euclid.esa.org/schema/pro/le3}pallasParams
...
CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'NRCat2'), pyxb.binding.datatypes.double, scope=CTD_ANON))

CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'NRCat1'), pyxb.binding.datatypes.double, scope=CTD_ANON))
CTD_ANON._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(None, u'NRCat1')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(None, u'NRCat2')), min_occurs=1, max_occurs=1)
    )
...
athenaParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'ScoordOutput'), STD_ANON_4, scope=athenaParams, documentation=u' Coordinate units of output files.'))
...
athenaParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'ScoordInput'), STD_ANON, scope=athenaParams, documentation=u' Coordinate units of input catalogues.'))
...
athenaParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'BinType'), STD_ANON_, scope=athenaParams, documentation=u' "Lin" or "Log" for linear or logarithmic bins. '))

athenaParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Coordinates'), STD_ANON_2, scope=athenaParams, documentation=u' Choose "Cartesian" or "Spherical" system of coordinates. '))
...
athenaParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'NResample'), CTD_ANON, scope=athenaParams, documentation=u' Give number of samples for error calculations for catalog 1 and 2. '))

athenaParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'EstError'), STD_ANON_3, scope=athenaParams, documentation=u' Controls error type, either "None","Bootstrap" or "Jackknife". '))
athenaParams._GroupModel = pyxb.binding.content.GroupSequence(
    ...
    pyxb.binding.content.ParticleModel(athenaParams._UseForTag(pyxb.namespace.ExpandedName(None, u'NResample')), min_occurs=1, max_occurs=1),
...
athenaParamsPosPos2D._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'TypeCorr'), pyxb.binding.datatypes.integer, scope=athenaParamsPosPos2D))

athenaParamsPosPos2D._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'SubTypeCorr'), pyxb.binding.datatypes.integer, scope=athenaParamsPosPos2D))
athenaParamsPosPos2D._GroupModel_ = pyxb.binding.content.GroupSequence(
    ...
    pyxb.binding.content.ParticleModel(athenaParamsPosPos2D._UseForTag(pyxb.namespace.ExpandedName(None, u'NResample')), min_occurs=1, max_occurs=1),
...
athenaParamsShearShear2D._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'TypeCorr'), pyxb.binding.datatypes.integer, scope=athenaParamsShearShear2D))

athenaParamsShearShear2D._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'SubTypeCorr'), pyxb.binding.datatypes.integer, scope=athenaParamsShearShear2D))
athenaParamsShearShear2D._GroupModel_ = pyxb.binding.content.GroupSequence(
    ...
    pyxb.binding.content.ParticleModel(athenaParamsShearShear2D._UseForTag(pyxb.namespace.ExpandedName(None, u'NResample')), min_occurs=1, max_occurs=1),
...
athenaParamsShearPos2D._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'TypeCorr'), pyxb.binding.datatypes.integer, scope=athenaParamsShearPos2D))

athenaParamsShearPos2D._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'SubTypeCorr'), pyxb.binding.datatypes.integer, scope=athenaParamsShearPos2D))
athenaParamsShearPos2D._GroupModel_ = pyxb.binding.content.GroupSequence(
    ...
    pyxb.binding.content.ParticleModel(athenaParamsShearPos2D._UseForTag(pyxb.namespace.ExpandedName(None, u'NResample')), min_occurs=1, max_occurs=1),
...
pallasParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'max_ell'), pyxb.binding.datatypes.long, scope=pallasParams, documentation=u' Maximal band limit. '))

pallasParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'min_ell'), pyxb.binding.datatypes.long, scope=pallasParams, documentation=u' Minimal band limit. '))
...
pallasParams._GroupModel = pyxb.binding.content.GroupSequence(
    ...
    pyxb.binding.content.ParticleModel(pallasParams._UseForTag(pyxb.namespace.ExpandedName(None, u'min_ell')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(pallasParams._UseForTag(pyxb.namespace.ExpandedName(None, u'max_ell')), min_occurs=1, max_occurs=1)
    )
...
pallasParamsShearShear2d._GroupModel_ = pyxb.binding.content.GroupSequence(
    ...
    pyxb.binding.content.ParticleModel(pallasParamsShearShear2d._UseForTag(pyxb.namespace.ExpandedName(None, u'min_ell')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(pallasParamsShearShear2d._UseForTag(pyxb.namespace.ExpandedName(None, u'max_ell')), min_occurs=1, max_occurs=1)
    )
