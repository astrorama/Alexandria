...
# Generated 2014-03-17 11:53:47.253220 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
STD_ANON.Cartesian = STD_ANON._CF_enumeration.addEnumeration(unicode_value=u'Cartesian')
STD_ANON.Spherical = STD_ANON._CF_enumeration.addEnumeration(unicode_value=u'Spherical')
...
STD_ANON_.None_ = STD_ANON_._CF_enumeration.addEnumeration(unicode_value=u'None')
STD_ANON_.BootStrap = STD_ANON_._CF_enumeration.addEnumeration(unicode_value=u'BootStrap')
STD_ANON_.Jackknife = STD_ANON_._CF_enumeration.addEnumeration(unicode_value=u'Jackknife')
...
STD_ANON_3.arcsec = STD_ANON_3._CF_enumeration.addEnumeration(unicode_value=u'arcsec')
STD_ANON_3.arcmin = STD_ANON_3._CF_enumeration.addEnumeration(unicode_value=u'arcmin')
STD_ANON_3.deg = STD_ANON_3._CF_enumeration.addEnumeration(unicode_value=u'deg')
STD_ANON_3.rad = STD_ANON_3._CF_enumeration.addEnumeration(unicode_value=u'rad')
...
athenaParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'ScoordInput'), STD_ANON_3, scope=athenaParams))
...
athenaParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'EstError'), STD_ANON_, scope=athenaParams))
...
athenaParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Coordinates'), STD_ANON, scope=athenaParams))
...
athenaParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'ScoordOutput'), STD_ANON_4, scope=athenaParams))
