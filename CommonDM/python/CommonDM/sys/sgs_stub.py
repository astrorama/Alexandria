# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/CommonDM/sys/sgs_stub.py
# PyXB bindings for NamespaceModule
# NSM:77d3da8c9c0b8eec64b9957d9ec227ca99caec32
# Generated 2014-03-14 15:21:54.439816 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
product._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ProductionDate'), CommonDM.sys_stub.systemDateTime, scope=product))

product._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Producer'), CommonDM.sys_stub.infraName, scope=product, documentation=u'Creator of the data.'))
...
storageNode._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Sdc'), CommonDM.sys_stub.infraName, scope=storageNode, documentation=u'Name of the SDC this storage node is associated with.'))
...
dataContainer._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Filename'), CommonDM.sys_stub.dataFileName, scope=dataContainer))
...
dataContainer._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'CreationDate'), CommonDM.sys_stub.systemDateTime, scope=dataContainer))
