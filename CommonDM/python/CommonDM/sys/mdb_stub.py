# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/CommonDM/sys/mdb_stub.py
# PyXB bindings for NamespaceModule
# NSM:8f18aa402fa0000678654b104d8a6cbeca1b5fe1
# Generated 2014-03-14 15:21:54.444904 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
class thematicParameter (pyxb.binding.basis.complexTypeDefinition):
    ...
    __unit = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'unit'), 'unit', '__httpeuclid_esa_orgschemasysmdb_thematicParameter_unit', CommonDM.bas.utd_stub.unit, required=True)
...
missionDataBaseSetOfParameters._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'StartValidity'), CommonDM.bas.imp.stc_stub.dateTime, scope=missionDataBaseSetOfParameters))

missionDataBaseSetOfParameters._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'ReleaseDate'), CommonDM.bas.imp.stc_stub.dateTime, scope=missionDataBaseSetOfParameters))

missionDataBaseSetOfParameters._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'EndValidity'), CommonDM.bas.imp.stc_stub.dateTime, scope=missionDataBaseSetOfParameters))
...
missionDataBaseSetOfParameters._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'GenericHeader'), CommonDM.sys_stub.genericHeader, scope=missionDataBaseSetOfParameters))
...
thematicParameterValue._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Array3D'), CommonDM.bas.dtd_stub.array3D, scope=thematicParameterValue))

thematicParameterValue._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'ListOfInteger'), CommonDM.bas.dtd_stub.listOfInteger4, scope=thematicParameterValue))

thematicParameterValue._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'FitsFile'), CommonDM.bas.fit_stub.fitsFile, scope=thematicParameterValue))
...
thematicParameterValue._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Array2D'), CommonDM.bas.dtd_stub.array2D, scope=thematicParameterValue))

thematicParameterValue._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'ListOfDouble'), CommonDM.bas.dtd_stub.listOfDouble, scope=thematicParameterValue))
