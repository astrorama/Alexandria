# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/CommonDM/bas/cat_stub.py
# PyXB bindings for NamespaceModule
# NSM:c307896550940a86ed318a515fbd77694cbd7804
# Generated 2014-03-14 15:21:54.444497 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
catalogSpatialCoverage._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'HTMList'), CommonDM.bas.dtd_stub.listOfInteger8, scope=catalogSpatialCoverage))
...
catalogSpectralCoverage._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'SpectrumRange'), CommonDM.ins.nis_stub.spectrumRange, scope=catalogSpectralCoverage))

catalogSpectralCoverage._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Filter'), CommonDM.bas.img_stub.filter, scope=catalogSpectralCoverage))
...
catalogContainer._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'GenericHeader'), CommonDM.sys_stub.genericHeader, scope=catalogContainer))
...
catalogProperty._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), CommonDM.bas.utd_stub.unit, scope=catalogProperty))
...
distanceRange._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), CommonDM.bas.utd_stub.unit, scope=distanceRange))
...
catalogPartitionStorage._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'DataContainer'), CommonDM.sys.sgs_stub.dataContainer, scope=catalogPartitionStorage))
...
boundingBox._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), CommonDM.bas.utd_stub.unit, scope=boundingBox))
