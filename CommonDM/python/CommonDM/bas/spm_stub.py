# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/CommonDM/bas/spm_stub.py
# PyXB bindings for NamespaceModule
# NSM:8f3807dbd7e5a83390236640f018e76f2abc9bfa
# Generated 2014-03-14 15:21:54.439429 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
spectrumMetadata._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ObjectName'), CommonDM.bas_stub.objectName, scope=spectrumMetadata, documentation=u''))
...
spectrumMetadata._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Coordinates'), CommonDM.bas.imp.stc_stub.astroCoordSystem, scope=spectrumMetadata, documentation=u''))
...
spectrum1DData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), CommonDM.bas.utd_stub.unit, scope=spectrum1DData))

spectrum1DData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Values'), CommonDM.bas.dtd_stub.listOfDouble, scope=spectrum1DData))
...
spectrum1DError._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), CommonDM.bas.utd_stub.unit, scope=spectrum1DError))

spectrum1DError._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Values'), CommonDM.bas.dtd_stub.listOfDouble, scope=spectrum1DError))
...
spectrum1DFlag._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), CommonDM.bas.utd_stub.unit, scope=spectrum1DFlag))

spectrum1DFlag._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Values'), CommonDM.bas.dtd_stub.listOfInteger8, scope=spectrum1DFlag))
