# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/CommonDM/bas/imp/stc_stub.py
# PyXB bindings for NamespaceModule
# NSM:c85a7aef9dd35afb45dde402fdc86e2ca92a56ad
# Generated 2014-03-14 15:21:54.439201 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
class pixelVector1CoordinateType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __CoordUnit = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'CoordUnit'), 'CoordUnit', '__httpeuclid_esa_orgschemabasimpstc_pixelVector1CoordinateType_CoordUnit', CommonDM.bas.utd_stub.unit)
...
class vector2CoordinateType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute CoordUnit uses Python identifier CoordUnit
    __CoordUnit = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'CoordUnit'), 'CoordUnit', '__httpeuclid_esa_orgschemabasimpstc_vector2CoordinateType_CoordUnit', CommonDM.bas.utd_stub.unit)
...
class pixelVector2CoordinateType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute CoordUnit uses Python identifier CoordUnit
    __CoordUnit = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'CoordUnit'), 'CoordUnit', '__httpeuclid_esa_orgschemabasimpstc_pixelVector2CoordinateType_CoordUnit', CommonDM.bas.utd_stub.unit)
...
class pixelVector3CoordinateType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute CoordUnit uses Python identifier CoordUnit
    __CoordUnit = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'CoordUnit'), 'CoordUnit', '__httpeuclid_esa_orgschemabasimpstc_pixelVector3CoordinateType_CoordUnit', CommonDM.bas.utd_stub.unit)
...
class timeCoordinateType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __TimeUnit = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'TimeUnit'), 'TimeUnit', '__httpeuclid_esa_orgschemabasimpstc_timeCoordinateType_TimeUnit', CommonDM.bas.utd_stub.unit)
...
class spectralIntervalType (coordScalarIntervalType):
    ...
    __SpectralUnit = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'SpectralUnit'), 'SpectralUnit', '__httpeuclid_esa_orgschemabasimpstc_spectralIntervalType_SpectralUnit', CommonDM.bas.utd_stub.unit, required=True)
...
class redshiftIntervalType (coordScalarIntervalType):
    ...
    # Attribute CoordUnit uses Python identifier CoordUnit
    __CoordUnit = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'CoordUnit'), 'CoordUnit', '__httpeuclid_esa_orgschemabasimpstc_redshiftIntervalType_CoordUnit', CommonDM.bas.utd_stub.unit, required=True)
    
    CoordUnit = property(__CoordUnit.value, __CoordUnit.set, None, None)

    
    # Attribute RedshiftUnit uses Python identifier RedshiftUnit
    __RedshiftUnit = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'RedshiftUnit'), 'RedshiftUnit', '__httpeuclid_esa_orgschemabasimpstc_redshiftIntervalType_RedshiftUnit', CommonDM.bas.utd_stub.unit, required=True)
...
class regionAreaType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __linearAreaUnit = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'linearAreaUnit'), 'linearAreaUnit', '__httpeuclid_esa_orgschemabasimpstc_regionAreaType_linearAreaUnit', CommonDM.bas.utd_stub.unit, required=True)
...
class vector3CoordinateType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute CoordUnit uses Python identifier CoordUnit
    __CoordUnit = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'CoordUnit'), 'CoordUnit', '__httpeuclid_esa_orgschemabasimpstc_vector3CoordinateType_CoordUnit', CommonDM.bas.utd_stub.unit)
...
class basicCoordinateType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute CoordUnit uses Python identifier CoordUnit
    __CoordUnit = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'CoordUnit'), 'CoordUnit', '__httpeuclid_esa_orgschemabasimpstc_basicCoordinateType_CoordUnit', CommonDM.bas.utd_stub.unit)
...
pixelVector1CoordinateType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Value'), CommonDM.bas.dtd_stub.double1Type, scope=pixelVector1CoordinateType))
...
vector2CoordinateType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Size2'), CommonDM.bas.dtd_stub.double2Type, scope=vector2CoordinateType))

vector2CoordinateType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'PixSize2'), CommonDM.bas.dtd_stub.double2Type, scope=vector2CoordinateType))

vector2CoordinateType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Error2'), CommonDM.bas.dtd_stub.double2Type, scope=vector2CoordinateType))
...
vector2CoordinateType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Value2'), CommonDM.bas.dtd_stub.double2Type, scope=vector2CoordinateType))

vector2CoordinateType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Resolution2'), CommonDM.bas.dtd_stub.double2Type, scope=vector2CoordinateType))
...
pixelVector2CoordinateType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Value2'), CommonDM.bas.dtd_stub.double2Type, scope=pixelVector2CoordinateType))
...
pixelVector3CoordinateType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Value3'), CommonDM.bas.dtd_stub.double3Type, scope=pixelVector3CoordinateType))
...
timeCoordinateType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Error'), CommonDM.bas.dtd_stub.double1Type, scope=timeCoordinateType))
...
timeCoordinateType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Resolution'), CommonDM.bas.dtd_stub.double1Type, scope=timeCoordinateType))

timeCoordinateType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Size'), CommonDM.bas.dtd_stub.double1Type, scope=timeCoordinateType))
...
timeCoordinateType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'PixSize'), CommonDM.bas.dtd_stub.double1Type, scope=timeCoordinateType))
...
coord2VecIntervalType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'HiLimit2Vec'), CommonDM.bas.dtd_stub.double2Type, scope=coord2VecIntervalType))

coord2VecIntervalType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'LoLimit2Vec'), CommonDM.bas.dtd_stub.double2Type, scope=coord2VecIntervalType))
...
coord3VecIntervalType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'HiLimit3Vec'), CommonDM.bas.dtd_stub.double3Type, scope=coord3VecIntervalType))

coord3VecIntervalType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'LoLimit3Vec'), CommonDM.bas.dtd_stub.double3Type, scope=coord3VecIntervalType))
...
ellipseType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Center'), CommonDM.bas.dtd_stub.double2Type, scope=ellipseType, documentation=u"The coordinates of the circle's center"))

ellipseType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'PosAngle'), CommonDM.bas.dtd_stub.double1Type, scope=ellipseType, documentation=u'Position angle of major axis (Radius).'))

ellipseType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'SemiMinorAxis'), CommonDM.bas.dtd_stub.double1Type, scope=ellipseType, documentation=u'Half the minor axis of the ellipse, in radius_unit'))

ellipseType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'SemiMajorAxis'), CommonDM.bas.dtd_stub.double1Type, scope=ellipseType, documentation=u'The radius of the circle'))
...
coordScalarIntervalType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'LoLimit'), CommonDM.bas.dtd_stub.double1Type, scope=coordScalarIntervalType, documentation=u'Lower bound of interval.'))

coordScalarIntervalType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'HiLimit'), CommonDM.bas.dtd_stub.double1Type, scope=coordScalarIntervalType, documentation=u'Upper bound of interval.'))
...
circleType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Radius'), CommonDM.bas.dtd_stub.double1Type, scope=circleType, documentation=u'The radius of the circle'))

circleType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Center'), CommonDM.bas.dtd_stub.double2Type, scope=circleType, documentation=u"The coordinates of the circle's center"))
...
boxType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Size'), CommonDM.bas.dtd_stub.double2Type, scope=boxType, documentation=u"The lengths of the box's sides"))

boxType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Center'), CommonDM.bas.dtd_stub.double2Type, scope=boxType, documentation=u"The coordinates of the box's center"))
...
smallCircleType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Pole'), CommonDM.bas.dtd_stub.double2Type, scope=smallCircleType))
...
sectorType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'PosAngle1'), CommonDM.bas.dtd_stub.double1Type, scope=sectorType, documentation=u'The area cw from this position angle is included'))

sectorType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'PosAngle2'), CommonDM.bas.dtd_stub.double1Type, scope=sectorType, documentation=u'The area cw from this position angle is included.'))

sectorType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Position'), CommonDM.bas.dtd_stub.double2Type, scope=sectorType, documentation=u'The vertex position of the sector'))
...
vertexType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Position'), CommonDM.bas.dtd_stub.double2Type, scope=vertexType))
...
vector3CoordinateType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Resolution3'), CommonDM.bas.dtd_stub.double3Type, scope=vector3CoordinateType))
...
vector3CoordinateType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Size3'), CommonDM.bas.dtd_stub.double3Type, scope=vector3CoordinateType))
...
vector3CoordinateType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'PixSize3'), CommonDM.bas.dtd_stub.double3Type, scope=vector3CoordinateType))

vector3CoordinateType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Value3'), CommonDM.bas.dtd_stub.double3Type, scope=vector3CoordinateType))

vector3CoordinateType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Error3'), CommonDM.bas.dtd_stub.double3Type, scope=vector3CoordinateType))
...
halfspaceType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Vector'), CommonDM.bas.dtd_stub.double3Type, scope=halfspaceType, documentation=u'This needs to be a spherical coordinate vector; it is the unit vector that is normal to the plane that forms a constraint for a convex'))
...
basicCoordinateType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'PixSize'), CommonDM.bas.dtd_stub.double1Type, scope=basicCoordinateType))

basicCoordinateType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Error'), CommonDM.bas.dtd_stub.double1Type, scope=basicCoordinateType))
...
basicCoordinateType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Resolution'), CommonDM.bas.dtd_stub.double1Type, scope=basicCoordinateType))

basicCoordinateType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Size'), CommonDM.bas.dtd_stub.double1Type, scope=basicCoordinateType))

basicCoordinateType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Value'), CommonDM.bas.dtd_stub.double1Type, scope=basicCoordinateType))
