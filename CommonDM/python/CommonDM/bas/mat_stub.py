# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/CommonDM/bas/mat_stub.py
# PyXB bindings for NamespaceModule
# NSM:53a93ef17c0962f27bddfa3d42e62d3223c59234
# Generated 2014-03-14 15:21:54.439022 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
varXYpolynomialModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'coefficients'), CommonDM.bas.dtd_stub.listOfDouble, scope=varXYpolynomialModel, documentation=u'First coefficient is constant coefficient'))
...
varXpolynomialModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'coefficients'), CommonDM.bas.dtd_stub.listOfDouble, scope=varXpolynomialModel, documentation=u'The length of the list must be degree+1, first is constant coefficient'))
...
varXpolynomialModelUnit._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), CommonDM.bas.utd_stub.unit, scope=varXpolynomialModelUnit))
...
varXYpolynomialModelUnit._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), CommonDM.bas.utd_stub.unit, scope=varXYpolynomialModelUnit))
