# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/CommonDM/pro/le3_stub.py
# PyXB bindings for NamespaceModule
# NSM:6e92490d80fbb6dc02a66078ea11ba566a411393
# Generated 2014-03-14 15:21:54.444132 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
STD_ANON.Lin = STD_ANON._CF_enumeration.addEnumeration(unicode_value=u'Lin')
STD_ANON.Log = STD_ANON._CF_enumeration.addEnumeration(unicode_value=u'Log')
...
STD_ANON_2.arcsec = STD_ANON_2._CF_enumeration.addEnumeration(unicode_value=u'arcsec')
STD_ANON_2.arcmin = STD_ANON_2._CF_enumeration.addEnumeration(unicode_value=u'arcmin')
STD_ANON_2.deg = STD_ANON_2._CF_enumeration.addEnumeration(unicode_value=u'deg')
STD_ANON_2.rad = STD_ANON_2._CF_enumeration.addEnumeration(unicode_value=u'rad')
...
class athenaOutputShearShear2D (CommonDM.bas.fit_stub.fitsFile):
    ...
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', CommonDM.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'le3.athena.output.shearshear2d', required=True)
...
class shearPspec2DLe3FitFile (CommonDM.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', CommonDM.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'le3.pallas.output.shearshearpspec2d', required=True)
...
class catalogLe3FitFile (CommonDM.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', CommonDM.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'le3.catalog', required=True)
...
athenaParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'ScoordInput'), STD_ANON_, scope=athenaParams))
...
athenaParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'ScoordOutput'), STD_ANON_2, scope=athenaParams))

athenaParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'BinType'), STD_ANON, scope=athenaParams))
