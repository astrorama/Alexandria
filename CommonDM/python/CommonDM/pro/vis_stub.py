# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/CommonDM/pro/vis_stub.py
# PyXB bindings for NamespaceModule
# NSM:d7aad58f46d0f1e4a455ef0880cce8c3de78c0ab
# Generated 2014-03-14 15:21:54.445360 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
STD_ANON.STD = STD_ANON._CF_enumeration.addEnumeration(unicode_value=u'STD')
STD_ANON.EXTRA = STD_ANON._CF_enumeration.addEnumeration(unicode_value=u'EXTRA')
...
STD_ANON_.WIDE_SURVEY = STD_ANON_._CF_enumeration.addEnumeration(unicode_value=u'WIDE SURVEY')
STD_ANON_.DEEP_SURVEY = STD_ANON_._CF_enumeration.addEnumeration(unicode_value=u'DEEP SURVEY')
STD_ANON_.CALIBRATION_VIS = STD_ANON_._CF_enumeration.addEnumeration(unicode_value=u'CALIBRATION VIS')
STD_ANON_.EXTRA_MODE = STD_ANON_._CF_enumeration.addEnumeration(unicode_value=u'EXTRA MODE')
...
class visBaseFrame (CommonDM.bas.img_stub.baseFrame):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = True
...
visBaseFrame._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Chip'), CommonDM.bas.img_stub.chip, scope=visBaseFrame, documentation=u' Information about the detector\n                                chip [None] '))
...
visBaseFrame._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ExposureMode'), STD_ANON_, scope=visBaseFrame))
...
visBaseFrame._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Filter'), CommonDM.bas.img_stub.filter, scope=visBaseFrame, documentation=u' Information about the\n                                observational filter [None] '))
...
visBaseFrame._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Dithering'), STD_ANON, scope=visBaseFrame))
...
cosmicMapParameters._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ExtObjectId'), CommonDM.bas_stub.extObjectId, scope=cosmicMapParameters, documentation=u' Unique EXT object identifier [None] '))
