# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/CommonDM/pro/spe_stub.py
# PyXB bindings for NamespaceModule
# NSM:26edd20c3857449d49a66aa8c083722722bbbacd
# Generated 2014-03-14 15:21:54.441526 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
import CommonDM.bas.imp.stc_stub
...
class calibratedSpectrum (CommonDM.bas.spm_stub.spectrumMetadata):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'calibratedSpectrum')
    # Base type is CommonDM.bas.spm_stub.spectrumMetadata
    ...
    _ElementMap = CommonDM.bas.spm_stub.spectrumMetadata._ElementMap.copy()
    _ElementMap.update({
        __SpectrumData.name() : __SpectrumData
    })
    _AttributeMap = CommonDM.bas.spm_stub.spectrumMetadata._AttributeMap.copy()
...
SPESpectralTemplates._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), CommonDM.sys_stub.genericHeader, scope=SPESpectralTemplates, documentation=u'The generic header of the product.'))
...
SPESpectralFeatures._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), CommonDM.sys_stub.genericHeader, scope=SPESpectralFeatures, documentation=u'The generic header of the product.'))
...
result._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Coordinates'), CommonDM.bas.imp.stc_stub.astroCoordSystem, scope=result))

result._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ObjectName'), CommonDM.bas_stub.objectName, scope=result))
...
SPEResults._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), CommonDM.sys_stub.genericHeader, scope=SPEResults, documentation=u'The generic header of the product.'))
...
spectralTemplate._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'spectrum'), CommonDM.bas.spm_stub.spectrum1DData, scope=spectralTemplate))
...
calibratedSpectrumData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'FluxError'), CommonDM.bas.spm_stub.spectrum1DError, scope=calibratedSpectrumData))

calibratedSpectrumData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'WavelengthError'), CommonDM.bas.spm_stub.spectrum1DError, scope=calibratedSpectrumData))

calibratedSpectrumData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Noise'), CommonDM.bas.spm_stub.spectrum1DError, scope=calibratedSpectrumData))

calibratedSpectrumData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Contamination'), CommonDM.bas.spm_stub.spectrum1DData, scope=calibratedSpectrumData))

calibratedSpectrumData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Wavelength'), CommonDM.bas.spm_stub.spectrum1DData, scope=calibratedSpectrumData))

calibratedSpectrumData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'PixelQuality'), CommonDM.bas.spm_stub.spectrum1DFlag, scope=calibratedSpectrumData))

calibratedSpectrumData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Flux'), CommonDM.bas.spm_stub.spectrum1DData, scope=calibratedSpectrumData))
...
SPECalibratedSpectra._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), CommonDM.sys_stub.genericHeader, scope=SPECalibratedSpectra, documentation=u'The generic header of the product.'))
