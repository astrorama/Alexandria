# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/CommonDM/pro/she_stub.py
# PyXB bindings for NamespaceModule
# NSM:7ac221f0a61cca2444b05519f207d18957d4a1cb
# Generated 2014-03-14 15:21:54.440885 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
class specZCatalog (CommonDM.bas.fit_stub.fitsFile):
    ...
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', CommonDM.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'sl.specZCatalog', required=True)
...
class photoZCatalog (CommonDM.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', CommonDM.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'sl.photoZCatalog', required=True)
...
class merCatalog (CommonDM.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', CommonDM.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'sl.merCatalog', required=True)
...
class preSelectedCatalog (CommonDM.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', CommonDM.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'sl.preSelectedCatalog', required=True)
...
class lensQuasarSubtractedStamp (CommonDM.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', CommonDM.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'sl.subtractedImage', required=True)
...
class lensCandidatesCatalog (CommonDM.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', CommonDM.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'sl.lensCandidatesCatalog', required=True)
...
class shearCatalog (CommonDM.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', CommonDM.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'sl.shearCatalog', required=True)
...
slPhotoZCatalog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), CommonDM.sys_stub.genericHeader, scope=slPhotoZCatalog, documentation=u'The generic header of the product.'))
...
slLensCandidatesCatalog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), CommonDM.sys_stub.genericHeader, scope=slLensCandidatesCatalog, documentation=u'The generic header of the product.'))
...
slNirFitsStamp._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), CommonDM.sys_stub.genericHeader, scope=slNirFitsStamp, documentation=u'The generic header of the product.'))

slNirFitsStamp._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Data'), CommonDM.sys.sgs_stub.dataContainer, scope=slNirFitsStamp, documentation=u'The data of the product.'))
...
slPreSelectionParameters._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), CommonDM.sys_stub.genericHeader, scope=slPreSelectionParameters, documentation=u'The generic header of the product.'))

slPreSelectionParameters._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Data'), CommonDM.sys.sgs_stub.dataContainer, scope=slPreSelectionParameters, documentation=u'The data of the product.'))
...
sl2DSpectrum._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Data'), CommonDM.sys.sgs_stub.dataContainer, scope=sl2DSpectrum, documentation=u'The data of the product.'))

sl2DSpectrum._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), CommonDM.sys_stub.genericHeader, scope=sl2DSpectrum, documentation=u'The generic header of the product.'))
...
slPreSelectedCatalog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), CommonDM.sys_stub.genericHeader, scope=slPreSelectedCatalog, documentation=u'The generic header of the product.'))
...
slLensQuasarSubtractedStamps._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), CommonDM.sys_stub.genericHeader, scope=slLensQuasarSubtractedStamps, documentation=u'The generic header of the product.'))
...
slVisCoAddedFrame._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Data'), CommonDM.sys.sgs_stub.dataContainer, scope=slVisCoAddedFrame, documentation=u'The data of the product.'))

slVisCoAddedFrame._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), CommonDM.sys_stub.genericHeader, scope=slVisCoAddedFrame, documentation=u'The generic header of the product.'))
...
slExtPsfModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Data'), CommonDM.sys.sgs_stub.dataContainer, scope=slExtPsfModel, documentation=u'The data of the product.'))

slExtPsfModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), CommonDM.sys_stub.genericHeader, scope=slExtPsfModel, documentation=u'The generic header of the product.'))
...
slPhysicalParametersCatalog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Data'), CommonDM.sys.sgs_stub.dataContainer, scope=slPhysicalParametersCatalog, documentation=u'The data of the product.'))

slPhysicalParametersCatalog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), CommonDM.sys_stub.genericHeader, scope=slPhysicalParametersCatalog, documentation=u'The generic header of the product.'))
...
slVisPsfModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Data'), CommonDM.sys.sgs_stub.dataContainer, scope=slVisPsfModel, documentation=u'The data of the product.'))

slVisPsfModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), CommonDM.sys_stub.genericHeader, scope=slVisPsfModel, documentation=u'The generic header of the product.'))
...
slNirCoAddedFrame._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), CommonDM.sys_stub.genericHeader, scope=slNirCoAddedFrame, documentation=u'The generic header of the product.'))

slNirCoAddedFrame._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Data'), CommonDM.sys.sgs_stub.dataContainer, scope=slNirCoAddedFrame, documentation=u'The data of the product.'))
...
slMerCatalog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), CommonDM.sys_stub.genericHeader, scope=slMerCatalog, documentation=u'The generic header of the product.'))
...
slNirPsfModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Data'), CommonDM.sys.sgs_stub.dataContainer, scope=slNirPsfModel, documentation=u'The data of the product.'))

slNirPsfModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), CommonDM.sys_stub.genericHeader, scope=slNirPsfModel, documentation=u'The generic header of the product.'))
...
slExtFrame._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Data'), CommonDM.sys.sgs_stub.dataContainer, scope=slExtFrame, documentation=u'The data of the product.'))

slExtFrame._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), CommonDM.sys_stub.genericHeader, scope=slExtFrame, documentation=u'The generic header of the product.'))
...
slShearCatalog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), CommonDM.sys_stub.genericHeader, scope=slShearCatalog, documentation=u'The generic header of the product.'))
...
visCalibratedImageAndMaskData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'RaDecCommanding'), CommonDM.bas.dtd_stub.listOf2Double, scope=visCalibratedImageAndMaskData))

visCalibratedImageAndMaskData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'VisCalibratedImage'), CommonDM.bas.fit_stub.fitsFile, scope=visCalibratedImageAndMaskData))

visCalibratedImageAndMaskData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'VisCalibratedImageMask'), CommonDM.bas.fit_stub.fitsFile, scope=visCalibratedImageAndMaskData))
...
slExtFitsStamp._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), CommonDM.sys_stub.genericHeader, scope=slExtFitsStamp, documentation=u'The generic header of the product.'))

slExtFitsStamp._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Data'), CommonDM.sys.sgs_stub.dataContainer, scope=slExtFitsStamp, documentation=u'The data of the product.'))
...
slSpecZCatalog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), CommonDM.sys_stub.genericHeader, scope=slSpecZCatalog, documentation=u'The generic header of the product.'))
...
slInspectionParameters._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), CommonDM.sys_stub.genericHeader, scope=slInspectionParameters, documentation=u'The generic header of the product.'))

slInspectionParameters._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Data'), CommonDM.sys.sgs_stub.dataContainer, scope=slInspectionParameters, documentation=u'The data of the product.'))
...
slVisFitsStamp._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Data'), CommonDM.sys.sgs_stub.dataContainer, scope=slVisFitsStamp, documentation=u'The data of the product.'))

slVisFitsStamp._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), CommonDM.sys_stub.genericHeader, scope=slVisFitsStamp, documentation=u'The generic header of the product.'))
