# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/CommonDM/ins/tel_stub.py
# PyXB bindings for NamespaceModule
# NSM:a659c9609d911b0b0de7dec344c20026ccc5f00c
# Generated 2014-03-14 15:21:54.441702 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
telescopeOptics._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Version'), CommonDM.sys_stub.version, scope=telescopeOptics))
...
scatteredNoiseModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Wavelength'), CommonDM.ins_stub.wavelength, scope=scatteredNoiseModel))

scatteredNoiseModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Flux'), CommonDM.ins_stub.flux, scope=scatteredNoiseModel))

scatteredNoiseModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Version'), CommonDM.sys_stub.version, scope=scatteredNoiseModel))

scatteredNoiseModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'CalibrationDataPath'), CommonDM.sys.sgs_stub.dataContainer, scope=scatteredNoiseModel))
...
diameter._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), CommonDM.bas.utd_stub.unit, scope=diameter))
...
obscuration._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), CommonDM.bas.utd_stub.unit, scope=obscuration))
...
telescopeNoiseModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Flux'), CommonDM.ins_stub.flux, scope=telescopeNoiseModel))

telescopeNoiseModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Wavelength'), CommonDM.ins_stub.wavelength, scope=telescopeNoiseModel))
...
telescopeNoiseModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'CalibrationDataPath'), CommonDM.sys.sgs_stub.dataContainer, scope=telescopeNoiseModel))

telescopeNoiseModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Version'), CommonDM.sys_stub.version, scope=telescopeNoiseModel))
