# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/CommonDM/ins/nis_stub.py
# PyXB bindings for NamespaceModule
# NSM:6e6d3cdee0146c7b53063e709e7bcb83a74176c6
# Generated 2014-03-14 15:21:54.440214 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
class transmissionFitsFile (CommonDM.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', CommonDM.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'nis.transmission', required=True)
...
class pixelPsfFitsFile (CommonDM.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', CommonDM.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'nis.pixelPsf', required=True)
...
class cosmicRayMap (CommonDM.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', CommonDM.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'nis.cosmicRayMap', required=True)
...
class quantumEfficiencyMap (CommonDM.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', CommonDM.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'nis.detectorQuantumEfficiencyMap', required=True)
...
class quantumEfficiencyCube (CommonDM.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', CommonDM.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'nis.detectorQuantumEfficiencyCube', required=True)
...
class readoutNoiseMap (CommonDM.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', CommonDM.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'nis.detectorReadoutNoiseMap', required=True)
...
class darkCurrentMap (CommonDM.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', CommonDM.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'nis.detectorDarkCurrentMap', required=True)
...
exposureTime._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), CommonDM.bas.utd_stub.unit, scope=exposureTime))
...
pointSpreadFunction._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ModelPSF'), CommonDM.bas.mat_stub.varXYpolynomialModel, scope=pointSpreadFunction))
...
dataCubeElement._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'FPAY'), CommonDM.bas.dtd_stub.doubleUnit, scope=dataCubeElement, documentation=u'Y Position of the PSF centroid in the FPA.'))

dataCubeElement._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Path'), CommonDM.sys.sgs_stub.dataContainer, scope=dataCubeElement, documentation=u'Path to the dataCube in FITS format that contains for different locations in the FPA (X,Y), the normalized PSF in (X,Y,Lambda).'))

dataCubeElement._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'FPAX'), CommonDM.bas.dtd_stub.doubleUnit, scope=dataCubeElement, documentation=u'X Position of the PSF centroid in the FPA.'))
...
doubleGaussianPSF._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'LambdaRef'), CommonDM.bas.dtd_stub.doubleUnit, scope=doubleGaussianPSF, documentation=u'Wavelength at which the PSF parameters have been measured.'))

doubleGaussianPSF._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'C'), CommonDM.bas.mat_stub.xyPolynome, scope=doubleGaussianPSF, documentation=u'Multiplicative factor of the small Gaussian. The big Gaussian is multiplied by (1-C). The coefficients of the polynomial describe the field dependence of this parameter.'))

doubleGaussianPSF._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'SigmaUnit'), CommonDM.bas.utd_stub.unit, scope=doubleGaussianPSF))

doubleGaussianPSF._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Sigma1'), CommonDM.bas.mat_stub.xyPolynome, scope=doubleGaussianPSF, documentation=u'Width of the small Gaussian. The coefficients of the polynomial describe the field dependence of this parameter.'))
...
doubleGaussianPSF._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Sigma2'), CommonDM.bas.mat_stub.xyPolynome, scope=doubleGaussianPSF, documentation=u'Width of the big Gaussian. The coefficients of the polynomial describe the field dependence of this parameter.'))
...
detectorInFPA._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'XFPA'), CommonDM.bas.dtd_stub.doubleUnit, scope=detectorInFPA, documentation=u'Relative X position of the detector in the FPA with respect to the FPA center, and in the North/East coordinate system.'))

detectorInFPA._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'RotAngle'), CommonDM.bas.dtd_stub.doubleUnit, scope=detectorInFPA, documentation=u'Rotation angle around the axis described by the vector normal to the FPA passing through the detector center. Angles are increasing CCW. Zero value means the detector is aligned with the North/East coordinate system. '))

detectorInFPA._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'YFPA'), CommonDM.bas.dtd_stub.doubleUnit, scope=detectorInFPA, documentation=u'Relative Y position of the detector in the FPA with respect to the FPA center, and in the North/East coordinate system.'))

detectorInFPA._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Elevation'), CommonDM.bas.dtd_stub.doubleUnit, scope=detectorInFPA, documentation=u'Elevation of the detector above or below the reference plane of the FPA.'))

detectorInFPA._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Identifier'), CommonDM.ins_stub.detectorId, scope=detectorInFPA))
...
curvatureModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), CommonDM.bas.utd_stub.unit, scope=curvatureModel, documentation=u'The unit used to describe the Start, End and polynomial coefficients of the trace. Default: um'))

curvatureModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'DispAngle'), CommonDM.bas.dtd_stub.degAngle, scope=curvatureModel, documentation=u'The dispersion direction (0 or 90). Counter-clockwise in the FPA frame.'))

curvatureModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Coefficients'), CommonDM.bas.mat_stub.xyPolynome, scope=curvatureModel, documentation=u'The coefficients of the polynomial DY = a0 + a1 DX + a2 DX^2 + ... Each coefficient (a0, a1, a2, etc) can be a constant or a 2D xy field dependent polynomial. '))
...
curvatureModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Version'), CommonDM.sys_stub.version, scope=curvatureModel))
...
curvatureModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'CalibrationDataPath'), CommonDM.sys.sgs_stub.dataContainer, scope=curvatureModel))
...
dispersionFunction._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'DLUnit'), CommonDM.bas.utd_stub.unit, scope=dispersionFunction, documentation=u'The unit used for the dispersion DL in the dispersion function. Default: Angstrom'))
...
dispersionFunction._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'CalibrationDataPath'), CommonDM.sys.sgs_stub.dataContainer, scope=dispersionFunction))

dispersionFunction._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Version'), CommonDM.sys_stub.version, scope=dispersionFunction))
...
dispersionFunction._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'DXUnit'), CommonDM.bas.utd_stub.unit, scope=dispersionFunction, documentation=u'The unit used for the displacement DX in the dispersion function. Default: um'))
...
psf._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AnalyticExpression'), CommonDM.bas.mat_stub.analyticExpression, scope=psf))
...
thermalNoiseModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Noise'), CommonDM.ins_stub.noise, scope=thermalNoiseModel))

thermalNoiseModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Wavelength'), CommonDM.ins_stub.wavelength, scope=thermalNoiseModel))

thermalNoiseModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Version'), CommonDM.sys_stub.version, scope=thermalNoiseModel))
...
straylightNoiseModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Noise'), CommonDM.ins_stub.noise, scope=straylightNoiseModel))

straylightNoiseModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Version'), CommonDM.sys_stub.version, scope=straylightNoiseModel))

straylightNoiseModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Wavelength'), CommonDM.ins_stub.wavelength, scope=straylightNoiseModel))
...
spectrumRange._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), CommonDM.bas.utd_stub.unit, scope=spectrumRange))

spectrumRange._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'RangeID'), CommonDM.bas.spm_stub.spectralRangeId, scope=spectrumRange, documentation=u'Name or ID commonly used for this spectral band'))
