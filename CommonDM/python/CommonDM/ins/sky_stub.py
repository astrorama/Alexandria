# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/CommonDM/ins/sky_stub.py
# PyXB bindings for NamespaceModule
# NSM:c511641e3e4c1554081270b88567f44db67597db
# Generated 2014-03-14 15:21:54.444235 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
class absorptionFactors (CommonDM.bas.fit_stub.fitsFile):
    ...
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', CommonDM.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'sky.absorptionFactors', required=True)
...
nPix._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), CommonDM.bas.utd_stub.unit, scope=nPix))
...
backgroundMap._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), CommonDM.bas.utd_stub.unit, scope=backgroundMap))

backgroundMap._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Image'), CommonDM.bas.img_stub.baseFrame, scope=backgroundMap))
...
skyCoordinate._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), CommonDM.bas.utd_stub.unit, scope=skyCoordinate))

skyCoordinate._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Value'), CommonDM.bas.dtd_stub.degAngle, scope=skyCoordinate))
...
skyBackground._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'WavelengthBand'), CommonDM.ins_stub.wavelengthBand, scope=skyBackground))
...
background._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'detectorIdentifier'), CommonDM.ins_stub.detectorId, scope=background, documentation=u'The identifier of the detector'))
