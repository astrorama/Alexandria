# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/euclid/dm/pro/le1_stub.py
# PyXB bindings for NamespaceModule
# NSM:23b1c64dcf05022ed49ac75f3cb8280755f2bfaf
# Generated 2014-03-14 09:43:27.470227 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
class nisRawFrameFitsFile (euclid.dm.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', euclid.dm.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'le1.nisRawImage', required=True)
...
class sirRawFrameFitsFile (euclid.dm.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', euclid.dm.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'le1.sirRawImage', required=True)
...
nispRawFrame._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ExposureTime'), euclid.dm.ins.nis_stub.exposureTime, scope=nispRawFrame, documentation=u'Exposure of the CCD in seconds'))
...
readoutMode._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ExpSampleTime'), euclid.dm.ins.nis_stub.exposureTime, scope=readoutMode, documentation=u' Exposure time in seconds for single samples of the readout'))
...
detectorFrame._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AstrometricSolution'), euclid.dm.bas.cot_stub.astrom, scope=detectorFrame))
