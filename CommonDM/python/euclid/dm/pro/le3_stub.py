# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/euclid/dm/pro/le3_stub.py
# PyXB bindings for NamespaceModule
# NSM:6e92490d80fbb6dc02a66078ea11ba566a411393
# Generated 2014-03-14 09:43:27.466884 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
class athenaOutputShearShear2D (euclid.dm.bas.fit_stub.fitsFile):
    ...
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', euclid.dm.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'le3.athena.output.shearshear2d', required=True)
...
class catalogLe3FitFile (euclid.dm.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', euclid.dm.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'le3.catalog', required=True)
...
class shearPspec2DLe3FitFile (euclid.dm.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', euclid.dm.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'le3.pallas.output.shearshearpspec2d', required=True)
