# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/euclid/dm/pro/spe_stub.py
# PyXB bindings for NamespaceModule
# NSM:26edd20c3857449d49a66aa8c083722722bbbacd
# Generated 2014-03-14 09:43:27.466178 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
import euclid.dm.bas.imp.stc_stub
...
class calibratedSpectrum (euclid.dm.bas.spm_stub.spectrumMetadata):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'calibratedSpectrum')
    # Base type is euclid.dm.bas.spm_stub.spectrumMetadata
    ...
    _ElementMap = euclid.dm.bas.spm_stub.spectrumMetadata._ElementMap.copy()
    _ElementMap.update({
        __SpectrumData.name() : __SpectrumData
    })
    _AttributeMap = euclid.dm.bas.spm_stub.spectrumMetadata._AttributeMap.copy()
...
calibratedSpectrumData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Wavelength'), euclid.dm.bas.spm_stub.spectrum1DData, scope=calibratedSpectrumData))

calibratedSpectrumData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Flux'), euclid.dm.bas.spm_stub.spectrum1DData, scope=calibratedSpectrumData))

calibratedSpectrumData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Contamination'), euclid.dm.bas.spm_stub.spectrum1DData, scope=calibratedSpectrumData))

calibratedSpectrumData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Noise'), euclid.dm.bas.spm_stub.spectrum1DError, scope=calibratedSpectrumData))

calibratedSpectrumData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'PixelQuality'), euclid.dm.bas.spm_stub.spectrum1DFlag, scope=calibratedSpectrumData))

calibratedSpectrumData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'WavelengthError'), euclid.dm.bas.spm_stub.spectrum1DError, scope=calibratedSpectrumData))

calibratedSpectrumData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'FluxError'), euclid.dm.bas.spm_stub.spectrum1DError, scope=calibratedSpectrumData))
...
SPEResults._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), euclid.dm.sys_stub.genericHeader, scope=SPEResults, documentation=u'The generic header of the product.'))
...
spectralTemplate._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'spectrum'), euclid.dm.bas.spm_stub.spectrum1DData, scope=spectralTemplate))
...
SPECalibratedSpectra._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), euclid.dm.sys_stub.genericHeader, scope=SPECalibratedSpectra, documentation=u'The generic header of the product.'))
...
SPESpectralTemplates._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), euclid.dm.sys_stub.genericHeader, scope=SPESpectralTemplates, documentation=u'The generic header of the product.'))
...
SPESpectralFeatures._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Header'), euclid.dm.sys_stub.genericHeader, scope=SPESpectralFeatures, documentation=u'The generic header of the product.'))
...
result._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Coordinates'), euclid.dm.bas.imp.stc_stub.astroCoordSystem, scope=result))

result._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ObjectName'), euclid.dm.bas_stub.objectName, scope=result))
