# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/euclid/dm/pro/sim_stub.py
# PyXB bindings for NamespaceModule
# NSM:e0267dec5fc6efe1abf4ebb30dbf85ca520d7023
# Generated 2014-03-14 09:43:27.465237 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
class STD_ANON (pyxb.binding.basis.STD_list):
    ...
    """Simple type that is a list of euclid.dm.ins.nis_stub.grismOrderName."""

    _ExpandedName = None
    _Documentation = None

    _ItemType = euclid.dm.ins.nis_stub.grismOrderName
...
class spectraFitsFile (euclid.dm.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', euclid.dm.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'sim.spectra', required=True)
...
class simFocalPlaneArangement (euclid.dm.ins.nis_stub.focalPlaneArrangement):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'simFocalPlaneArangement')
    # Base type is euclid.dm.ins.nis_stub.focalPlaneArrangement
    ...
    _ElementMap = euclid.dm.ins.nis_stub.focalPlaneArrangement._ElementMap.copy()
    _ElementMap.update({
    ...
    _AttributeMap = euclid.dm.ins.nis_stub.focalPlaneArrangement._AttributeMap.copy()
    _AttributeMap.update({
...
class spectrumFile (euclid.dm.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', euclid.dm.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'sim.spectrum', required=True)
...
class catalogFitsFile (euclid.dm.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', euclid.dm.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'sim.catalog', required=True)
...
class averageReadoutNoise (pyxb.binding.basis.complexTypeDefinition):
    _TypeDefinition = euclid.dm.bas.dtd_stub.positiveDouble
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_SIMPLE
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'averageReadoutNoise')
    # Base type is euclid.dm.bas.dtd_stub.positiveDouble
...
class nipSimulatedImage (euclid.dm.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', euclid.dm.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'sim.nipSimulatedImage', required=True)
...
class simulatedImageFitsFile (euclid.dm.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', euclid.dm.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'sim.simulatedImage', required=True)
...
tipsInputConfiguration._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'OpticsModel'), euclid.dm.ins.nis_stub.grismModeModel, scope=tipsInputConfiguration))
...
simulationSettings._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ExposureTime'), euclid.dm.ins.nis_stub.exposureTime, scope=simulationSettings, documentation=u'The duration of the exposure of the CCD in seconds.'))
...
simFocalPlaneArangement._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'DetectorGapInY'), euclid.dm.bas.dtd_stub.positiveDouble, scope=simFocalPlaneArangement, documentation=u'The gap between adjacent detectors in the vertical (Y) direction, expressed in um. Inacive pixel margins are included. This value is ment for simulation reasons only and, when present, will override the per detector gap information from the FPA DetectorPositionList (only row/column information will be used).'))
...
simFocalPlaneArangement._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'DetectorGapInX'), euclid.dm.bas.dtd_stub.positiveDouble, scope=simFocalPlaneArangement, documentation=u'The gap between adjacent detectors in the horizontal (X) direction, expressed in um. Inacive pixel margins are included. This value is ment for simulation reasons only and, when present, will override the per detector gap information from the FPA DetectorPositionList (only row/column information will be used).'))
...
detectorList._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Detector'), euclid.dm.ins.nis_stub.detector, scope=detectorList))
...
shearParameter._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'RAUnit'), euclid.dm.bas.utd_stub.unit, scope=shearParameter))
...
shearParameter._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'DECUnit'), euclid.dm.bas.utd_stub.unit, scope=shearParameter))
...
emissionLine._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'FluxUnit'), euclid.dm.bas.utd_stub.unit, scope=emissionLine))

emissionLine._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'WidthUnit'), euclid.dm.bas.utd_stub.unit, scope=emissionLine))
...
emissionLine._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'FWHMUnit'), euclid.dm.bas.utd_stub.unit, scope=emissionLine))
...
shapeletModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Coefficients'), euclid.dm.bas.dtd_stub.listOfDouble, scope=shapeletModel, documentation=u'Coefficients of shapelets as NxM matrix'))
...
dataVISNISPSimulationInterfaces._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'TelescopePointingRA'), euclid.dm.bas.dtd_stub.degAngle, scope=dataVISNISPSimulationInterfaces, documentation=u'Right Ascension of the pointing angles of the telescope in the center of the field.'))

dataVISNISPSimulationInterfaces._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ObservationMode'), euclid.dm.ins_stub.observationMode, scope=dataVISNISPSimulationInterfaces, documentation=u'refer to observation Mode used for the simulation runtime : calibration, wide or deep.'))
...
dataVISNISPSimulationInterfaces._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'TelescopePointingDec'), euclid.dm.bas.dtd_stub.degAngle, scope=dataVISNISPSimulationInterfaces, documentation=u'Declinaison of the pointing angles of the telescope in the center of the field.'))

dataVISNISPSimulationInterfaces._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'PixelSimulatorVersion'), euclid.dm.sys_stub.version, scope=dataVISNISPSimulationInterfaces, documentation=u'Refer here to the version of the SW simulator code.'))
...
dataVISNISPSimulationInterfaces._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'FPADetectorList'), euclid.dm.bas.dtd_stub.listOfInteger2, scope=dataVISNISPSimulationInterfaces, documentation=u'List of detector identifiers simulated.'))

dataVISNISPSimulationInterfaces._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'GrismOrderSimulation'), euclid.dm.bas.dtd_stub.listOfInteger2, scope=dataVISNISPSimulationInterfaces, documentation=u'Order of the grism simulation image inside the fits file.'))
...
wavelengthRange._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'WavelenthUnit'), euclid.dm.bas.utd_stub.unit, scope=wavelengthRange))
...
simulatedExposureSequence._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'FPAPointingDec'), euclid.dm.bas.dtd_stub.degAngle, scope=simulatedExposureSequence, documentation=u'Declinaison of the pointing angles of the FPA via the telescope in the Bottom Left of the detector.'))

simulatedExposureSequence._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'SelectedGrism'), euclid.dm.ins.nis_stub.grismName, scope=simulatedExposureSequence, documentation=u'Refers to the Grism mode selected : GBlue or Gred and polar angle 0 or 90'))

simulatedExposureSequence._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ExposureTime'), euclid.dm.ins.nis_stub.exposureTime, scope=simulatedExposureSequence, documentation=u'Refers to the duration of Exposure expressed in seconds with the resolution of the us'))

simulatedExposureSequence._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'FPAPointingRA'), euclid.dm.bas.dtd_stub.degAngle, scope=simulatedExposureSequence, documentation=u'Right Ascension of the pointing angles of the FPA via the telescope in the Bottom Left of the detector.'))
...
metadataVISNISPSimulationInterfaces._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Header'), euclid.dm.sys_stub.genericHeader, scope=metadataVISNISPSimulationInterfaces))
...
nipCatalogProduct._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'DataContainer'), euclid.dm.sys.sgs_stub.dataContainer, scope=nipCatalogProduct))
...
nipSimulationSettings._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'FilterName'), euclid.dm.ins.nis_stub.filterName, scope=nipSimulationSettings, documentation=u'The name of the filter to simulate.'))
...
SED._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'WavelengthUnit'), euclid.dm.bas.utd_stub.unit, scope=SED))

SED._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'FluxUnit'), euclid.dm.bas.utd_stub.unit, scope=SED))
...
morphologyModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'PositionAngleUnit'), euclid.dm.bas.utd_stub.unit, scope=morphologyModel))

morphologyModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'SersicRadiuses'), euclid.dm.bas.dtd_stub.listOfDouble, scope=morphologyModel))
...
morphologyModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'SersicIndexes'), euclid.dm.bas.dtd_stub.listOfDouble, scope=morphologyModel))
...
morphologyModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'SersicRadiusUnit'), euclid.dm.bas.utd_stub.unit, scope=morphologyModel))
...
morphologyImage._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'DataContainer'), euclid.dm.sys.sgs_stub.dataContainer, scope=morphologyImage))

morphologyImage._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'PositionAngleUnit'), euclid.dm.bas.utd_stub.unit, scope=morphologyImage))
...
galaxySource._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'SpectrumStorage'), euclid.dm.sys.sgs_stub.dataContainer, scope=galaxySource))
...
galaxySource._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Identifier'), euclid.dm.bas_stub.objectId, scope=galaxySource))
...
fpaPointing._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Dec'), euclid.dm.bas.dtd_stub.degAngle, scope=fpaPointing, documentation=u'Declination of the FPA, in degrees.'))

fpaPointing._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Orientation'), euclid.dm.bas.dtd_stub.degAngle, scope=fpaPointing, documentation=u'Counterclockwise angle from the positive RA axis, in degrees.'))

fpaPointing._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'RA'), euclid.dm.bas.dtd_stub.degAngle, scope=fpaPointing, documentation=u'Right ascension of the FPA, in degrees.'))
...
morphologyGeneric._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'MinorAxisUnit'), euclid.dm.bas.utd_stub.unit, scope=morphologyGeneric))
...
morphologyGeneric._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'MajorAxisUnit'), euclid.dm.bas.utd_stub.unit, scope=morphologyGeneric))

morphologyGeneric._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'DiskHalfRadiusUnit'), euclid.dm.bas.utd_stub.unit, scope=morphologyGeneric))
...
morphologyGeneric._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'PositionAngleUnit'), euclid.dm.bas.utd_stub.unit, scope=morphologyGeneric))
...
morphologyGeneric._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'BuldgeHalfRadiusUnit'), euclid.dm.bas.utd_stub.unit, scope=morphologyGeneric))
...
filterTransmission._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Wavelength'), euclid.dm.ins_stub.wavelength, scope=filterTransmission))

filterTransmission._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'TransmissionFactor'), euclid.dm.ins_stub.transmissionFactor, scope=filterTransmission))
...
filterTransmission._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ErrorOnTransmission'), euclid.dm.ins_stub.errorOnTransmission, scope=filterTransmission))

filterTransmission._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'CalibrationDataPath'), euclid.dm.sys.sgs_stub.dataContainer, scope=filterTransmission))
...
simulationInputModels._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'GalaxyAbsorptionInputDataMoodel'), euclid.dm.sys.sgs_stub.dataContainer, scope=simulationInputModels, documentation=u'Reference to Galaxy absorption input data model (refFormat).'))

simulationInputModels._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'NISPInputDataModel'), euclid.dm.sys.sgs_stub.dataContainer, scope=simulationInputModels, documentation=u'Reference to NISP input data model (refFormat).'))
...
simulationInputModels._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'TelescopeInputDataModel'), euclid.dm.sys.sgs_stub.dataContainer, scope=simulationInputModels, documentation=u'Reference to Telescope input data model.'))

simulationInputModels._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'NISPOpticsInputDataModel'), euclid.dm.sys.sgs_stub.dataContainer, scope=simulationInputModels, documentation=u'Reference to NISP optics input data model (refFormat).'))

simulationInputModels._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'SkyBackgroundInputDataModel'), euclid.dm.sys.sgs_stub.dataContainer, scope=simulationInputModels, documentation=u'Reference to Sky background input data model (refFormat).'))

simulationInputModels._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'TelescopeOpticsInputDataModel'), euclid.dm.sys.sgs_stub.dataContainer, scope=simulationInputModels, documentation=u'Reference to Telescope optics input data model (refFormat)'))
