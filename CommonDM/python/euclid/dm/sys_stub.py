# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/euclid/dm/sys_stub.py
# PyXB bindings for NamespaceModule
# NSM:ef11d8db76a7f46c6c12cc44757c7de95f0af727
# Generated 2014-03-14 09:43:27.463389 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
genericHeader._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ProductName'), euclid.dm.bas_stub.objectName, scope=genericHeader, documentation=u'Product Name, the interface embeds one and only one Product. This information is derived from the task schema input/output name. '))
...
genericHeader._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ProductId'), euclid.dm.bas_stub.objectId, scope=genericHeader, documentation=u'This Id is the unique reference of the object defined in thi interface, this Id is processed by IAL to ensure the uniqueness.'))
