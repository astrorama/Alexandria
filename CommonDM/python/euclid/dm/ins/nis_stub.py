# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/euclid/dm/ins/nis_stub.py
# PyXB bindings for NamespaceModule
# NSM:6e6d3cdee0146c7b53063e709e7bcb83a74176c6
# Generated 2014-03-14 09:43:27.465074 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
class darkCurrentMap (euclid.dm.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', euclid.dm.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'nis.detectorDarkCurrentMap', required=True)
...
class quantumEfficiencyMap (euclid.dm.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', euclid.dm.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'nis.detectorQuantumEfficiencyMap', required=True)
...
class quantumEfficiencyCube (euclid.dm.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', euclid.dm.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'nis.detectorQuantumEfficiencyCube', required=True)
...
class transmissionFitsFile (euclid.dm.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', euclid.dm.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'nis.transmission', required=True)
...
class readoutNoiseMap (euclid.dm.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', euclid.dm.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'nis.detectorReadoutNoiseMap', required=True)
...
class pixelPsfFitsFile (euclid.dm.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', euclid.dm.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'nis.pixelPsf', required=True)
...
class cosmicRayMap (euclid.dm.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', euclid.dm.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'nis.cosmicRayMap', required=True)
...
curvatureModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), euclid.dm.bas.utd_stub.unit, scope=curvatureModel, documentation=u'The unit used to describe the Start, End and polynomial coefficients of the trace. Default: um'))

curvatureModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'DispAngle'), euclid.dm.bas.dtd_stub.degAngle, scope=curvatureModel, documentation=u'The dispersion direction (0 or 90). Counter-clockwise in the FPA frame.'))
...
curvatureModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Version'), euclid.dm.sys_stub.version, scope=curvatureModel))

curvatureModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'CalibrationDataPath'), euclid.dm.sys.sgs_stub.dataContainer, scope=curvatureModel))
...
dispersionFunction._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'DXUnit'), euclid.dm.bas.utd_stub.unit, scope=dispersionFunction, documentation=u'The unit used for the displacement DX in the dispersion function. Default: um'))

dispersionFunction._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'CalibrationDataPath'), euclid.dm.sys.sgs_stub.dataContainer, scope=dispersionFunction))
...
dispersionFunction._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'DLUnit'), euclid.dm.bas.utd_stub.unit, scope=dispersionFunction, documentation=u'The unit used for the dispersion DL in the dispersion function. Default: Angstrom'))

dispersionFunction._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Version'), euclid.dm.sys_stub.version, scope=dispersionFunction))
...
distortionModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), euclid.dm.bas.utd_stub.unit, scope=distortionModel, documentation=u'The unit used to describe the polynomial coefficients of the X and Y offsets. Default: um'))

distortionModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Yoff'), euclid.dm.bas.mat_stub.xyPolynome, scope=distortionModel, documentation=u'A column offset between the reference position of this grism order and the position of the object on the FPA. This can be a 2D field dependent representation.'))

distortionModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Xoff'), euclid.dm.bas.mat_stub.xyPolynome, scope=distortionModel, documentation=u'A row offset between the reference position of this grism order and the position of the object on the FPA. This can be a 2D field dependent representation.'))
...
straylightNoiseModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Noise'), euclid.dm.ins_stub.noise, scope=straylightNoiseModel))
...
straylightNoiseModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Wavelength'), euclid.dm.ins_stub.wavelength, scope=straylightNoiseModel))
...
straylightNoiseModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Version'), euclid.dm.sys_stub.version, scope=straylightNoiseModel))
...
psf._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AnalyticExpression'), euclid.dm.bas.mat_stub.analyticExpression, scope=psf))
...
exposureTime._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), euclid.dm.bas.utd_stub.unit, scope=exposureTime))
...
spectrumRange._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'RangeID'), euclid.dm.bas.spm_stub.spectralRangeId, scope=spectrumRange, documentation=u'Name or ID commonly used for this spectral band'))

spectrumRange._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), euclid.dm.bas.utd_stub.unit, scope=spectrumRange))
...
thermalNoiseModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Version'), euclid.dm.sys_stub.version, scope=thermalNoiseModel))
...
thermalNoiseModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Noise'), euclid.dm.ins_stub.noise, scope=thermalNoiseModel))
...
thermalNoiseModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Wavelength'), euclid.dm.ins_stub.wavelength, scope=thermalNoiseModel))
...
detectorInFPA._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'YFPA'), euclid.dm.bas.dtd_stub.doubleUnit, scope=detectorInFPA, documentation=u'Relative Y position of the detector in the FPA with respect to the FPA center, and in the North/East coordinate system.'))

detectorInFPA._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'RotAngle'), euclid.dm.bas.dtd_stub.doubleUnit, scope=detectorInFPA, documentation=u'Rotation angle around the axis described by the vector normal to the FPA passing through the detector center. Angles are increasing CCW. Zero value means the detector is aligned with the North/East coordinate system. '))

detectorInFPA._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'XFPA'), euclid.dm.bas.dtd_stub.doubleUnit, scope=detectorInFPA, documentation=u'Relative X position of the detector in the FPA with respect to the FPA center, and in the North/East coordinate system.'))

detectorInFPA._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Elevation'), euclid.dm.bas.dtd_stub.doubleUnit, scope=detectorInFPA, documentation=u'Elevation of the detector above or below the reference plane of the FPA.'))

detectorInFPA._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Identifier'), euclid.dm.ins_stub.detectorId, scope=detectorInFPA))
...
pointSpreadFunction._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ModelPSF'), euclid.dm.bas.mat_stub.varXYpolynomialModel, scope=pointSpreadFunction))
...
dataCubeElement._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'FPAY'), euclid.dm.bas.dtd_stub.doubleUnit, scope=dataCubeElement, documentation=u'Y Position of the PSF centroid in the FPA.'))

dataCubeElement._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Path'), euclid.dm.sys.sgs_stub.dataContainer, scope=dataCubeElement, documentation=u'Path to the dataCube in FITS format that contains for different locations in the FPA (X,Y), the normalized PSF in (X,Y,Lambda).'))

dataCubeElement._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'FPAX'), euclid.dm.bas.dtd_stub.doubleUnit, scope=dataCubeElement, documentation=u'X Position of the PSF centroid in the FPA.'))
...
doubleGaussianPSF._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Sigma2'), euclid.dm.bas.mat_stub.xyPolynome, scope=doubleGaussianPSF, documentation=u'Width of the big Gaussian. The coefficients of the polynomial describe the field dependence of this parameter.'))

doubleGaussianPSF._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Sigma1'), euclid.dm.bas.mat_stub.xyPolynome, scope=doubleGaussianPSF, documentation=u'Width of the small Gaussian. The coefficients of the polynomial describe the field dependence of this parameter.'))

doubleGaussianPSF._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'LambdaRef'), euclid.dm.bas.dtd_stub.doubleUnit, scope=doubleGaussianPSF, documentation=u'Wavelength at which the PSF parameters have been measured.'))
