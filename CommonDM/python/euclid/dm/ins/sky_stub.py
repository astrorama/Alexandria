# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/euclid/dm/ins/sky_stub.py
# PyXB bindings for NamespaceModule
# NSM:c511641e3e4c1554081270b88567f44db67597db
# Generated 2014-03-14 09:43:27.470548 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
class absorptionFactors (euclid.dm.bas.fit_stub.fitsFile):
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_fitsFile_format', euclid.dm.bas.fit_stub.fitsFormatIdentifier, fixed=True, unicode_default=u'sky.absorptionFactors', required=True)
...
skyCoordinate._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), euclid.dm.bas.utd_stub.unit, scope=skyCoordinate))

skyCoordinate._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Value'), euclid.dm.bas.dtd_stub.degAngle, scope=skyCoordinate))
...
skyBackground._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'WavelengthBand'), euclid.dm.ins_stub.wavelengthBand, scope=skyBackground))
...
nPix._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), euclid.dm.bas.utd_stub.unit, scope=nPix))
...
backgroundMap._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), euclid.dm.bas.utd_stub.unit, scope=backgroundMap))

backgroundMap._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Image'), euclid.dm.bas.img_stub.baseFrame, scope=backgroundMap))
...
background._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'detectorIdentifier'), euclid.dm.ins_stub.detectorId, scope=background, documentation=u'The identifier of the detector'))
