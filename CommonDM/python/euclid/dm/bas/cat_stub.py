# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/euclid/dm/bas/cat_stub.py
# PyXB bindings for NamespaceModule
# NSM:c307896550940a86ed318a515fbd77694cbd7804
# Generated 2014-03-14 09:43:27.466656 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
catalogProperty._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), euclid.dm.bas.utd_stub.unit, scope=catalogProperty))
...
catalogSpectralCoverage._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'SpectrumRange'), euclid.dm.ins.nis_stub.spectrumRange, scope=catalogSpectralCoverage))

catalogSpectralCoverage._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Filter'), euclid.dm.bas.img_stub.filter, scope=catalogSpectralCoverage))
...
catalogPartitionStorage._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'DataContainer'), euclid.dm.sys.sgs_stub.dataContainer, scope=catalogPartitionStorage))
...
catalogContainer._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'GenericHeader'), euclid.dm.sys_stub.genericHeader, scope=catalogContainer))
...
catalogSpatialCoverage._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'HTMList'), euclid.dm.bas.dtd_stub.listOfInteger8, scope=catalogSpatialCoverage))
...
boundingBox._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), euclid.dm.bas.utd_stub.unit, scope=boundingBox))
...
distanceRange._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), euclid.dm.bas.utd_stub.unit, scope=distanceRange))
