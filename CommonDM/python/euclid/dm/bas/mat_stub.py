# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/euclid/dm/bas/mat_stub.py
# PyXB bindings for NamespaceModule
# NSM:53a93ef17c0962f27bddfa3d42e62d3223c59234
# Generated 2014-03-14 09:43:27.463622 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
varXYpolynomialModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'coefficients'), euclid.dm.bas.dtd_stub.listOfDouble, scope=varXYpolynomialModel, documentation=u'First coefficient is constant coefficient'))
...
varXYpolynomialModelUnit._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), euclid.dm.bas.utd_stub.unit, scope=varXYpolynomialModelUnit))
...
varXpolynomialModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'coefficients'), euclid.dm.bas.dtd_stub.listOfDouble, scope=varXpolynomialModel, documentation=u'The length of the list must be degree+1, first is constant coefficient'))
...
varXpolynomialModelUnit._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), euclid.dm.bas.utd_stub.unit, scope=varXpolynomialModelUnit))
