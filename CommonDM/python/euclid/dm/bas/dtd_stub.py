# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/euclid/dm/bas/dtd_stub.py
# PyXB bindings for NamespaceModule
# NSM:b271ffc25c73f887dbff4e054cfd41e733c35b7f
# Generated 2014-03-14 09:43:27.463507 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
class double2Type (pyxb.binding.basis.complexTypeDefinition):
    ...
    __CoordUnit = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'CoordUnit'), 'CoordUnit', '__httpeuclid_esa_orgschemabasdtd_double2Type_CoordUnit', euclid.dm.bas.utd_stub.unit)
...
class array3D (pyxb.binding.basis.complexTypeDefinition):
    ...
    __Xunit = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'Xunit'), 'Xunit', '__httpeuclid_esa_orgschemabasdtd_array3D_Xunit', euclid.dm.bas.utd_stub.unit, required=True)
    
    Xunit = property(__Xunit.value, __Xunit.set, None, None)

    
    # Attribute Zunit uses Python identifier Zunit
    __Zunit = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'Zunit'), 'Zunit', '__httpeuclid_esa_orgschemabasdtd_array3D_Zunit', euclid.dm.bas.utd_stub.unit, required=True)
    
    Zunit = property(__Zunit.value, __Zunit.set, None, None)

    
    # Attribute Yunit uses Python identifier Yunit
    __Yunit = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'Yunit'), 'Yunit', '__httpeuclid_esa_orgschemabasdtd_array3D_Yunit', euclid.dm.bas.utd_stub.unit, required=True)
...
class double3Type (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute CoordUnit uses Python identifier CoordUnit
    __CoordUnit = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'CoordUnit'), 'CoordUnit', '__httpeuclid_esa_orgschemabasdtd_double3Type_CoordUnit', euclid.dm.bas.utd_stub.unit)
...
class double1Type (pyxb.binding.basis.complexTypeDefinition):
    ...
    __unit = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'unit'), 'unit', '__httpeuclid_esa_orgschemabasdtd_double1Type_unit', euclid.dm.bas.utd_stub.unit)
...
class array2D (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute Yunit uses Python identifier Yunit
    __Yunit = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'Yunit'), 'Yunit', '__httpeuclid_esa_orgschemabasdtd_array2D_Yunit', euclid.dm.bas.utd_stub.unit, required=True)
    
    Yunit = property(__Yunit.value, __Yunit.set, None, None)

    
    # Attribute Xunit uses Python identifier Xunit
    __Xunit = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'Xunit'), 'Xunit', '__httpeuclid_esa_orgschemabasdtd_array2D_Xunit', euclid.dm.bas.utd_stub.unit, required=True)
...
class double4Type (pyxb.binding.basis.complexTypeDefinition):
    ...
    __MijUnit = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'MijUnit'), 'MijUnit', '__httpeuclid_esa_orgschemabasdtd_double4Type_MijUnit', euclid.dm.bas.utd_stub.unit)
...
class double9Type (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute MijUnit uses Python identifier MijUnit
    __MijUnit = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'MijUnit'), 'MijUnit', '__httpeuclid_esa_orgschemabasdtd_double9Type_MijUnit', euclid.dm.bas.utd_stub.unit)
...
doubleUnit._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Unit'), euclid.dm.bas.utd_stub.unit, scope=doubleUnit))
