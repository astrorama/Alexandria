# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/euclid/dm/bas/fit_stub.py
# PyXB bindings for NamespaceModule
# NSM:975654cc63c7654a0853e9fafa22678e8820cfb9
# Generated 2014-03-14 09:43:27.464830 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
import euclid.dm.bas.imp.fits_stub
...
class headerUndefinedKeyword (pyxb.binding.basis.complexTypeDefinition):
    ...
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpeuclid_esa_orgschemabasfit_headerUndefinedKeyword_name', euclid.dm.bas.imp.fits_stub.headerKeywordName, required=True)
...
class headerStringKeyword (pyxb.binding.basis.complexTypeDefinition):
    ...
    __fixed = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'fixed'), 'fixed', '__httpeuclid_esa_orgschemabasfit_headerStringKeyword_fixed', euclid.dm.bas.imp.fits_stub.stringKeywordValue)
    
    fixed = property(__fixed.value, __fixed.set, None, None)

    
    # Attribute name uses Python identifier name
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpeuclid_esa_orgschemabasfit_headerStringKeyword_name', euclid.dm.bas.imp.fits_stub.headerKeywordName, required=True)
...
class headerDoubleKeyword (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute fixed uses Python identifier fixed
    __fixed = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'fixed'), 'fixed', '__httpeuclid_esa_orgschemabasfit_headerDoubleKeyword_fixed', euclid.dm.bas.imp.fits_stub.doubleKeywordValue)
    
    fixed = property(__fixed.value, __fixed.set, None, None)

    
    # Attribute name uses Python identifier name
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpeuclid_esa_orgschemabasfit_headerDoubleKeyword_name', euclid.dm.bas.imp.fits_stub.headerKeywordName, required=True)
...
class headerIntegerKeyword (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute fixed uses Python identifier fixed
    __fixed = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'fixed'), 'fixed', '__httpeuclid_esa_orgschemabasfit_headerIntegerKeyword_fixed', euclid.dm.bas.imp.fits_stub.integerKeywordValue)
    
    fixed = property(__fixed.value, __fixed.set, None, None)

    
    # Attribute name uses Python identifier name
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpeuclid_esa_orgschemabasfit_headerIntegerKeyword_name', euclid.dm.bas.imp.fits_stub.headerKeywordName, required=True)
...
class headerComplexDoubleKeyword (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute fixed uses Python identifier fixed
    __fixed = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'fixed'), 'fixed', '__httpeuclid_esa_orgschemabasfit_headerComplexDoubleKeyword_fixed', euclid.dm.bas.imp.fits_stub.complexDoubleKeywordValue)
    
    fixed = property(__fixed.value, __fixed.set, None, None)

    
    # Attribute name uses Python identifier name
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpeuclid_esa_orgschemabasfit_headerComplexDoubleKeyword_name', euclid.dm.bas.imp.fits_stub.headerKeywordName, required=True)
...
class headerLogicalKeyword (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute fixed uses Python identifier fixed
    __fixed = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'fixed'), 'fixed', '__httpeuclid_esa_orgschemabasfit_headerLogicalKeyword_fixed', euclid.dm.bas.imp.fits_stub.logicalKeywordValue)
    
    fixed = property(__fixed.value, __fixed.set, None, None)

    
    # Attribute name uses Python identifier name
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpeuclid_esa_orgschemabasfit_headerLogicalKeyword_name', euclid.dm.bas.imp.fits_stub.headerKeywordName, required=True)
...
class binaryTableColumn (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute name uses Python identifier name
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpeuclid_esa_orgschemabasfit_binaryTableColumn_name', euclid.dm.bas.imp.fits_stub.binaryTableColumnName, required=True)
    
    name = property(__name.value, __name.set, None, None)

    
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_binaryTableColumn_format', euclid.dm.bas.imp.fits_stub.binaryTableColumnFormat, required=True)
    
    format = property(__format.value, __format.set, None, None)

    
    # Attribute unit uses Python identifier unit
    __unit = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'unit'), 'unit', '__httpeuclid_esa_orgschemabasfit_binaryTableColumn_unit', euclid.dm.bas.utd_stub.unit, required=True)
...
class headerComplexIntegerKeyword (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute fixed uses Python identifier fixed
    __fixed = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'fixed'), 'fixed', '__httpeuclid_esa_orgschemabasfit_headerComplexIntegerKeyword_fixed', euclid.dm.bas.imp.fits_stub.complexIntegerKeywordValue)
    
    fixed = property(__fixed.value, __fixed.set, None, None)

    
    # Attribute name uses Python identifier name
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpeuclid_esa_orgschemabasfit_headerComplexIntegerKeyword_name', euclid.dm.bas.imp.fits_stub.headerKeywordName, required=True)
...
class wcsAxis (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute name uses Python identifier name
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpeuclid_esa_orgschemabasfit_wcsAxis_name', euclid.dm.bas.imp.fits_stub.wcsAxisName, required=True)
    
    name = property(__name.value, __name.set, None, None)

    
    # Attribute type uses Python identifier type
    __type = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'type'), 'type', '__httpeuclid_esa_orgschemabasfit_wcsAxis_type', euclid.dm.bas.imp.fits_stub.wcsAxisType, required=True)
    
    type = property(__type.value, __type.set, None, None)

    
    # Attribute unit uses Python identifier unit
    __unit = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'unit'), 'unit', '__httpeuclid_esa_orgschemabasfit_wcsAxis_unit', euclid.dm.bas.utd_stub.unit, required=True)
    
    unit = property(__unit.value, __unit.set, None, None)

    
    # Attribute projectionAlgorithm uses Python identifier projectionAlgorithm
    __projectionAlgorithm = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'projectionAlgorithm'), 'projectionAlgorithm', '__httpeuclid_esa_orgschemabasfit_wcsAxis_projectionAlgorithm', euclid.dm.bas.imp.fits_stub.wcsAxisProjectionAlgorithm)
...
class wcsType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __identifier = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'identifier'), 'identifier', '__httpeuclid_esa_orgschemabasfit_wcsType_identifier', euclid.dm.bas.imp.fits_stub.wcsIdentifier, required=True)
    
    identifier = property(__identifier.value, __identifier.set, None, None)

    
    # Attribute name uses Python identifier name
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'name'), 'name', '__httpeuclid_esa_orgschemabasfit_wcsType_name', euclid.dm.bas.imp.fits_stub.wcsName, required=True)
...
class arrayInfo (pyxb.binding.basis.complexTypeDefinition):
    ...
    __numberOfDimentions = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'numberOfDimentions'), 'numberOfDimentions', '__httpeuclid_esa_orgschemabasfit_arrayInfo_numberOfDimentions', euclid.dm.bas.imp.fits_stub.arrayNumberOfDimensions, required=True)
    
    numberOfDimentions = property(__numberOfDimentions.value, __numberOfDimentions.set, None, None)

    
    # Attribute format uses Python identifier format
    __format = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'format'), 'format', '__httpeuclid_esa_orgschemabasfit_arrayInfo_format', euclid.dm.bas.imp.fits_stub.arrayFormat, required=True)
    
    format = property(__format.value, __format.set, None, None)

    
    # Attribute unit uses Python identifier unit
    __unit = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'unit'), 'unit', '__httpeuclid_esa_orgschemabasfit_arrayInfo_unit', euclid.dm.bas.utd_stub.unit, required=True)
...
fitsFile._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'DataContainer'), euclid.dm.sys.sgs_stub.dataContainer, scope=fitsFile))
