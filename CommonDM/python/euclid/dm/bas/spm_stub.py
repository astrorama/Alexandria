# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/euclid/dm/bas/spm_stub.py
# PyXB bindings for NamespaceModule
# NSM:8f3807dbd7e5a83390236640f018e76f2abc9bfa
# Generated 2014-03-14 09:43:27.464964 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
spectrum1DError._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), euclid.dm.bas.utd_stub.unit, scope=spectrum1DError))

spectrum1DError._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Values'), euclid.dm.bas.dtd_stub.listOfDouble, scope=spectrum1DError))
...
spectrum1DData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), euclid.dm.bas.utd_stub.unit, scope=spectrum1DData))

spectrum1DData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Values'), euclid.dm.bas.dtd_stub.listOfDouble, scope=spectrum1DData))
...
spectrum1DFlag._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Unit'), euclid.dm.bas.utd_stub.unit, scope=spectrum1DFlag))

spectrum1DFlag._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Values'), euclid.dm.bas.dtd_stub.listOfInteger8, scope=spectrum1DFlag))
...
spectrumMetadata._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Coordinates'), euclid.dm.bas.imp.stc_stub.astroCoordSystem, scope=spectrumMetadata, documentation=u''))
...
spectrumMetadata._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ObjectName'), euclid.dm.bas_stub.objectName, scope=spectrumMetadata, documentation=u''))
