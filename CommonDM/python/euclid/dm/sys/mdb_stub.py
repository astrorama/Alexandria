# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/euclid/dm/sys/mdb_stub.py
# PyXB bindings for NamespaceModule
# NSM:8f18aa402fa0000678654b104d8a6cbeca1b5fe1
# Generated 2014-03-14 09:43:27.466362 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
class thematicParameter (pyxb.binding.basis.complexTypeDefinition):
    ...
    __unit = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'unit'), 'unit', '__httpeuclid_esa_orgschemasysmdb_thematicParameter_unit', euclid.dm.bas.utd_stub.unit, required=True)
...
missionDataBaseSetOfParameters._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'EndValidity'), euclid.dm.bas.imp.stc_stub.dateTime, scope=missionDataBaseSetOfParameters))
...
missionDataBaseSetOfParameters._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'ReleaseDate'), euclid.dm.bas.imp.stc_stub.dateTime, scope=missionDataBaseSetOfParameters))

missionDataBaseSetOfParameters._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'GenericHeader'), euclid.dm.sys_stub.genericHeader, scope=missionDataBaseSetOfParameters))

missionDataBaseSetOfParameters._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'StartValidity'), euclid.dm.bas.imp.stc_stub.dateTime, scope=missionDataBaseSetOfParameters))
...
thematicParameterValue._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Array2D'), euclid.dm.bas.dtd_stub.array2D, scope=thematicParameterValue))
...
thematicParameterValue._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'ListOfDouble'), euclid.dm.bas.dtd_stub.listOfDouble, scope=thematicParameterValue))

thematicParameterValue._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'Array3D'), euclid.dm.bas.dtd_stub.array3D, scope=thematicParameterValue))
...
thematicParameterValue._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'FitsFile'), euclid.dm.bas.fit_stub.fitsFile, scope=thematicParameterValue))

thematicParameterValue._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, u'ListOfInteger'), euclid.dm.bas.dtd_stub.listOfInteger4, scope=thematicParameterValue))
