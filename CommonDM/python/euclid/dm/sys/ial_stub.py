# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/euclid/dm/sys/ial_stub.py
# PyXB bindings for NamespaceModule
# NSM:14b174fbf2463221ba40c6210b8bbc1f0cac46a0
# Generated 2014-03-14 09:43:27.469161 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
taskProduct._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ProductRef'), euclid.dm.sys.sgs_stub.fileDescriptor, scope=taskProduct))
...
sgsProcessingOrder._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'PipelineDescription'), euclid.dm.sys.sgs_stub.dataContainer, scope=sgsProcessingOrder))
...
ialConfiguration._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Sdc'), euclid.dm.sys_stub.infraName, scope=ialConfiguration))
...
logFile._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'File'), euclid.dm.sys.sgs_stub.dataContainer, scope=logFile))
...
clusterConfiguration._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Workspace'), euclid.dm.sys.sgs_stub.storageNode, scope=clusterConfiguration))

clusterConfiguration._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Sdc'), euclid.dm.sys_stub.infraName, scope=clusterConfiguration))
...
pipelineRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'EndDate'), euclid.dm.sys_stub.systemDateTime, scope=pipelineRun))
...
pipelineRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'StartDate'), euclid.dm.sys_stub.systemDateTime, scope=pipelineRun))
