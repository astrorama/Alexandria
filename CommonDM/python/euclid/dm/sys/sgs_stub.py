# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/euclid/dm/sys/sgs_stub.py
# PyXB bindings for NamespaceModule
# NSM:77d3da8c9c0b8eec64b9957d9ec227ca99caec32
# Generated 2014-03-14 09:43:27.463922 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
dataContainer._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'CreationDate'), euclid.dm.sys_stub.systemDateTime, scope=dataContainer))

dataContainer._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Filename'), euclid.dm.sys_stub.dataFileName, scope=dataContainer))
...
product._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ProductionDate'), euclid.dm.sys_stub.systemDateTime, scope=product))

product._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Producer'), euclid.dm.sys_stub.infraName, scope=product, documentation=u'Creator of the data.'))
...
storageNode._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Sdc'), euclid.dm.sys_stub.infraName, scope=storageNode, documentation=u'Name of the SDC this storage node is associated with.'))
