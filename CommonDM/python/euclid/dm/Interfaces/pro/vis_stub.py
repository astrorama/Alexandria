# /home/nikoapos/ISDC/Projects/Alexandria/1.0/CommonDM/python/euclid/dm/Interfaces/pro/vis_stub.py
# PyXB bindings for NamespaceModule
# NSM:539c73c8f73a663b381cbefc2c790f5c063cac08
# Generated 2014-03-14 09:43:27.469807 by PyXB version 1.1.2
import pyxb
import pyxb.binding
...
SimInputConfiguration = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'SimInputConfiguration'), euclid.dm.pro.sim_stub.visInputConfiguration)
...
VisInputConfiguration = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'VisInputConfiguration'), euclid.dm.pro.vis_stub.visBaseFrame)
Namespace.addCategoryObject('elementBinding', VisInputConfiguration.name().localName(), VisInputConfiguration)

GainLinearityInputConfiguration = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'GainLinearityInputConfiguration'), euclid.dm.pro.vis_stub.gainLinearity)
...
BiasInput._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Master'), euclid.dm.pro.vis_stub.masterFlatFrame, scope=BiasInput))

BiasInput._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Bias'), euclid.dm.pro.vis_stub.biasFrame, scope=BiasInput))
