...
BOOST_AUTO_TEST_CASE(combinationOfValues) {
  ...
  auto result = std::make_tuple(
    ChMatrix::AxisInfo<double>{"", {}},
    ChMatrix::AxisInfo<DCC>{"", {}},
    ChMatrix::AxisInfo<NDCC>{"", {}}
  );
  boost::archive::binary_iarchive bia {stream};
  bia >> result;
...
//-----------------------------------------------------------------------------
// Test serialization of tuple with AxisInfo values. This test is performed
// because serialization of tuples is implemented only for this reason. Note
// that this test might detect problems related with the AxisInfo serialization
