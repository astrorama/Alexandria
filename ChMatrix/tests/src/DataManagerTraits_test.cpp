/** 
 * @file DataManagerTraits_test.cpp
 * @date July 4, 2014
...
BOOST_AUTO_TEST_SUITE (DataManagerTraits_test)

//-----------------------------------------------------------------------------
// Test the default operations of the DataManagerTraits
//-----------------------------------------------------------------------------
...
BOOST_AUTO_TEST_CASE(defaultOperations) {
  ...
  // When
  typedef ChMatrix::DataManagerTraits<DefaultDataManager> traits;
...
//-----------------------------------------------------------------------------
// Test the operations of the DataManagerTraits for a vector
//-----------------------------------------------------------------------------
...
BOOST_AUTO_TEST_CASE(vectorOperations) {
  ...
  // When
  typedef ChMatrix::DataManagerTraits<VectorDataManager> traits;
  auto result = traits::factory(5);
